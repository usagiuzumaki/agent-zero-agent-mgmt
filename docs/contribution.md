# Contributing to Aria - Creative Companion

Contributions to improve Aria - Creative Companion are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Aria - Creative Companion repository on GitHub.
...
* **Code Style:** Follow the existing code style. Aria - Creative Companion generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Aria - Creative Companion repository.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve Aria - Creative Companion for everyone's benefit.