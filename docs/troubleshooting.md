...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Aria Bot.

## Frequently Asked Questions
**1. How do I ask Aria Bot to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. Aria Bot will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with Aria Bot?**
...
**6. How can I make Aria Bot retain memory between sessions?**
Refer to the [How to update Aria Bot](installation.md#how-to-update-aria-bot) section of the documentation for instructions on how to update Aria Bot while retaining memory and data.

**7. Where can I find more documentation or tutorials?**
-   Join the Aria Bot [Skool](https://www.skool.com/agent-zero) or [Discord](https://discord.gg/B8KZKNsPpj) community for support and discussions.
...
**10. Can Aria Bot interact with external APIs or services (e.g., WhatsApp)?**
Extending Aria Bot to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them.
...
* **Performance Issues:** If Aria Bot is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.