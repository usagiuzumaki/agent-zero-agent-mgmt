...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Aria - Creative Companion.

## Frequently Asked Questions
**1. How do I ask Aria - Creative Companion to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. Aria - Creative Companion will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with Aria - Creative Companion?**
...
**6. How can I make Aria - Creative Companion retain memory between sessions?**
Refer to the [How to update Aria - Creative Companion](installation.md#how-to-update-aria---creative-companion) section of the documentation for instructions on how to update Aria - Creative Companion while retaining memory and data.

**7. Where can I find more documentation or tutorials?**
-   Join the Aria - Creative Companion [Skool](https://www.skool.com/agent-zero) or [Discord](https://discord.gg/B8KZKNsPpj) community for support and discussions.
...
**10. Can Aria - Creative Companion interact with external APIs or services (e.g., WhatsApp)?**
Extending Aria - Creative Companion to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them.
...
* **Performance Issues:** If Aria - Creative Companion is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.