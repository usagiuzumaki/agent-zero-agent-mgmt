# Usage Guide
This guide explores usage and configuration scenarios for Aria - Creative Companion. You can consider this as a reference post-installation guide.

![Utility Message with Solutions](res/memory-man.png)

## Basic Operations
Aria - Creative Companion provides several basic operations through its interface:

### Restart Framework
The Restart button allows you to quickly restart the Aria - Creative Companion framework without using the terminal:
...
### Action Buttons
Located beneath the chat input box, Aria - Creative Companion provides a set of action buttons for enhanced control and visibility:
...
### File Browser: Manage files in the Aria - Creative Companion environment
...
### File Attachments
Aria - Creative Companion supports direct file attachments in the chat interface for seamless file operations:
...
## Tool Usage
Aria - Creative Companion's power comes from its ability to use [tools](architecture.md#tools). Here's how to leverage them effectively:

- **Understand Tools:** Aria - Creative Companion includes default tools like knowledge (powered by SearXNG), code execution, and communication. Understand the capabilities of these tools and how to invoke them.

## Example of Tools Usage: Web Search and Code Execution
Let's say you want Aria - Creative Companion to perform some financial analysis tasks. Here's a possible prompt:
...
Aria - Creative Companion might then:
...
> [!NOTE]
> The first run of `code_execution_tool` may take a while as it downloads and builds the Aria - Creative Companion Docker image. Subsequent runs will be faster.

This example demonstrates how to combine multiple tools to achieve an analysis task. By mastering prompt engineering and tool usage, you can unlock the full potential of Aria - Creative Companion to solve complex problems.

## Multi-Agent Cooperation
One of Aria - Creative Companion's unique features is multi-agent cooperation.
...
* **Hierarchy:** Aria - Creative Companion uses a [hierarchical structure](architecture.md#agent-hierarchy-and-communication), with superior agents delegating tasks to subordinates.  This allows for structured problem-solving and efficient resource allocation.

![](res/physics.png)
![](res/physics-2.png)

## Prompt Engineering
Effective prompt engineering is crucial for getting the most out of Aria - Creative Companion. Here are some tips and techniques:

* **Be Clear and Specific:** Clearly state your desired outcome.  The more specific you are, the better Aria - Creative Companion can understand and fulfill your request.  Avoid vague or ambiguous language.
...
## Voice Interface
Aria - Creative Companion provides both Text-to-Speech (TTS) and Speech-to-Text (STT) capabilities for natural voice interaction:
...
Aria - Creative Companion supports KaTeX for beautiful mathematical typesetting:
...
### File Browser
Aria - Creative Companion provides a powerful file browser interface for managing your workspace:
...
> [!NOTE]
> The files browser allows the user to go in the Aria - Creative Companion root folder if you click the `Up` button, but the working directory of Agents will always be `/work_dir`
>
- **File Operations**:
...
> [!TIP]
> The File Browser integrates seamlessly with Aria - Creative Companion's capabilities. You can reference files directly in your conversations, and the agent can help you manage, modify, and organize your files.

## Backup & Restore
Aria - Creative Companion provides a comprehensive backup and restore system to protect your data and configurations. This feature helps you safeguard your work and migrate Aria - Creative Companion setups between different systems.
...
#### What Gets Backed Up
By default, Aria - Creative Companion backs up your most important data:
...
The restore process allows you to recover your Aria - Creative Companion setup from a previous backup:
...
* **Before System Updates**: Backup before updating Aria - Creative Companion or system components
...
* **External Storage**: Keep backup files in a safe location outside Aria - Creative Companion
...
#### System Migration
Moving Aria - Creative Companion to a new server or computer:
1. Create a complete backup on the original system
2. Install Aria - Creative Companion on the new system
...
#### Team Collaboration
Sharing Aria - Creative Companion configurations:
...
> [!TIP]
> The backup system is designed to work across different operating systems and Aria - Creative Companion installations. Your backups from a Windows system will work on Linux, and vice versa.
