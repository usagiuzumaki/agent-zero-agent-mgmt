# Usage Guide
This guide explores usage and configuration scenarios for Aria Bot. You can consider this as a reference post-installation guide.

![Utility Message with Solutions](res/memory-man.png)

## Basic Operations
Aria Bot provides several basic operations through its interface:

### Restart Framework
The Restart button allows you to quickly restart the Aria Bot framework without using the terminal:
...
### Action Buttons
Located beneath the chat input box, Aria Bot provides a set of action buttons for enhanced control and visibility:
...
### File Browser: Manage files in the Aria Bot environment
...
### File Attachments
Aria Bot supports direct file attachments in the chat interface for seamless file operations:
...
## Tool Usage
Aria Bot's power comes from its ability to use [tools](architecture.md#tools). Here's how to leverage them effectively:

- **Understand Tools:** Aria Bot includes default tools like knowledge (powered by SearXNG), code execution, and communication. Understand the capabilities of these tools and how to invoke them.

## Example of Tools Usage: Web Search and Code Execution
Let's say you want Aria Bot to perform some financial analysis tasks. Here's a possible prompt:
...
> [!NOTE]
> The first run of `code_execution_tool` may take a while as it downloads and builds the Aria Bot Docker image. Subsequent runs will be faster.

This example demonstrates how to combine multiple tools to achieve an analysis task. By mastering prompt engineering and tool usage, you can unlock the full potential of Aria Bot to solve complex problems.

## Multi-Agent Cooperation
One of Aria Bot's unique features is multi-agent cooperation.
...
* **Hierarchy:** Aria Bot uses a [hierarchical structure](architecture.md#agent-hierarchy-and-communication), with superior agents delegating tasks to subordinates.  This allows for structured problem-solving and efficient resource allocation.

![](res/physics.png)
![](res/physics-2.png)

## Prompt Engineering
Effective prompt engineering is crucial for getting the most out of Aria Bot. Here are some tips and techniques:

* **Be Clear and Specific:** Clearly state your desired outcome.  The more specific you are, the better Aria Bot can understand and fulfill your request.  Avoid vague or ambiguous language.
...
## Voice Interface
Aria Bot provides both Text-to-Speech (TTS) and Speech-to-Text (STT) capabilities for natural voice interaction:
...
Aria Bot supports KaTeX for beautiful mathematical typesetting:
...
### File Browser
Aria Bot provides a powerful file browser interface for managing your workspace:
...
> [!NOTE]
> The files browser allows the user to go in the Aria Bot root folder if you click the `Up` button, but the working directory of Agents will always be `/work_dir`
>
- **File Operations**:
...
> [!TIP]
> The File Browser integrates seamlessly with Aria Bot's capabilities. You can reference files directly in your conversations, and the agent can help you manage, modify, and organize your files.

## Backup & Restore
Aria Bot provides a comprehensive backup and restore system to protect your data and configurations. This feature helps you safeguard your work and migrate Aria Bot setups between different systems.
...
#### What Gets Backed Up
By default, Aria Bot backs up your most important data:
...
The restore process allows you to recover your Aria Bot setup from a previous backup:
...
* **Before System Updates**: Backup before updating Aria Bot or system components
...
* **External Storage**: Keep backup files in a safe location outside Aria Bot
...
#### System Migration
Moving Aria Bot to a new server or computer:
1. Create a complete backup on the original system
2. Install Aria Bot on the new system
...
#### Team Collaboration
Sharing Aria Bot configurations:
...
> [!TIP]
> The backup system is designed to work across different operating systems and Aria Bot installations. Your backups from a Windows system will work on Linux, and vice versa.
