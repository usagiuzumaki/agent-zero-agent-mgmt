...
class SceneBreakdown(Tool):
    """
    Breaks a prompt or outline into scenes using a subordinate agent.
    """
    def __init__(self, agent: Agent, name="scene_breakdown", method=None, args=None, message="", loop_data=None, **kwargs):
    ...
    async def execute(self, **kwargs) -> Response:
        ...
        instruction = f"You are a Screenwriting Specialist: Scene Breakdown. Break the following outline or prompt into discrete scenes.\nOutline:\n{context}"
