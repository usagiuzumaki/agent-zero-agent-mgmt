...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by Aria - AI Creative Companion",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by Aria - AI Creative Companion",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. Aria - AI Creative Companion uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> agentic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use Aria - AI Creative Companion Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by Aria - AI Creative Companion.",
    ...
    memory_fields.append(
        {
            ...
            "description": "Aria - AI Creative Companion will automatically recall memories based on conversation context.",
            "type": "switch",
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "Aria - AI Creative Companion can use external MCP servers, local or remote as tools.",
    ...
    mcp_server_fields.append(
        {
            ...
            "title": "Enable Aria - AI Creative Companion MCP Server",
            "description": "Expose Aria - AI Creative Companion as an SSE MCP server. This will make this instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "title": "Aria - AI Creative Companion MCP Server",
        "description": "Aria - AI Creative Companion can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore Aria - AI Creative Companion data and configurations "
