...
- **[Installation](installation.md):** Set up (or [update](installation.md#how-to-update-agent-zero)) Aria Bot on your system.
...
- **Join the Community:** Join the Aria Bot [Skool](https://www.skool.com/agent-zero) or [Discord](https://discord.gg/B8KZKNsPpj) community to discuss ideas, ask questions, and collaborate with other contributors.
...
- [Welcome to the Aria Bot Documentation](#agent-zero-documentation)
  - [Your Experience with Aria Bot](#your-experience-with-agent-zero-starts-now)
...
- [Installation Guide](installation.md)
  ...
  - [Using Aria Bot on Mobile](installation.md#using-agent-zero-on-your-mobile-device)
  - [How to Update Aria Bot](installation.md#how-to-update-agent-zero)
