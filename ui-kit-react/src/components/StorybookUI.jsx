      ...
      {showUpload && (
        <div className="storybook-upload">
          ...
          <form onSubmit={handleUpload}>
            <label htmlFor="upload-title" className="input-label">Document Title</label>
            <input
              id="upload-title"
              type="text"
              ...
              autoFocus
            />
            <label htmlFor="upload-content" className="input-label">Paste Text Content</label>
            <textarea
              id="upload-content"
                      ...
                      >
                        ...
                        <div className="beat-footer">
                             <button className="btn-draft">
                                <span aria-hidden="true">✍️</span> Draft Scene
                             </button>
                        </div>
                      </div>
                    ))}
